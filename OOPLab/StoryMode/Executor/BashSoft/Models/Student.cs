...
namespace Executor.Models
{
    public class Student
    {
        ...
        public IDictionary<string, Course> EnrolledCourses
        {
            get
            {
        ...
        public void EnrollInCourse(Course course)
        {
            ...
            {
               throw new DuplicateWaitObjectException(this.UserName,course.Name);
            }
        ...
        public void SetMarkOnCourse(string courseName,params int[] scores)
        {
            ...
            {
                throw new KeyNotFoundException(courseName);
        ...
        {
            double percentageOfSolvedExam = scores.Sum() / (double)(Course.NumberOfTasksOnExam *
                Course.MaxScoreOnExamTask);
